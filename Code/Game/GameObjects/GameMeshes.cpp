...
//  =========================================================================================
Mesh* AddBlockToMesh(MeshBuilder* builder, const Vector3& center, Block* block)
{
	float xVal = 0.5f;
	float yVal = 0.5f;
	float zVal = 0.5f;
	...
	builder->SetUV(texCoords.mins.x, texCoords.mins.y);
	...
	builder->SetColor(tint);
	builder->SetUV(texCoords.maxs.x, texCoords.mins.y);
	builder->SetNormal(Vector3(0.f, 0.f, -1.f));
	builder->SetTangent(Vector4(1.f, 0.f, 0.f, 1.f));
	builder->PushVertex(Vector3(center.x - xVal, center.y - yVal, center.z - zVal));	

	builder->SetColor(tint);
	builder->SetUV(texCoords.maxs.x, texCoords.maxs.y);
	builder->SetNormal(Vector3(0.f, 0.f, -1.f));
	builder->SetTangent(Vector4(1.f, 0.f, 0.f, 1.f));
	builder->PushVertex(Vector3(center.x - xVal,  center.y - yVal, center.z + zVal));	

	builder->SetColor(tint);
	builder->SetUV(texCoords.mins.x, texCoords.maxs.y);
	builder->SetNormal(Vector3(0.f, 0.f, -1.f));
	builder->SetTangent(Vector4(1.f, 0.f, 0.f, 1.f));
	builder->PushVertex(Vector3(center.x - xVal, center.y + yVal, center.z + zVal));		
